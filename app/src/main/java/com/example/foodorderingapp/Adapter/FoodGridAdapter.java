...
public class FoodGridAdapter extends RecyclerView.Adapter<FoodGridAdapter.ViewHolder> {
    ...
    public FoodGridAdapter(List<Food> items) {
        this.items = items;
    }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.viewholder_food_grid, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.scoreTxt.setText(String.valueOf(food.getStar()));
